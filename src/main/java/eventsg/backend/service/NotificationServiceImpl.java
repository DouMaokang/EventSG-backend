...
public class NotificationServiceImpl {
    ...
    public List<Notification> getNotificationList(UUID userId) {
        ...
        for (Event event : registeredEvents) {
            ...
            this.addEventToNotificationList(false,notificationList,event);
        }
     ...
     * @param event event object
     */
    public void addEventToNotificationList(Boolean firstAdded,List<Notification> notificationList,Event event) {
        ...
        notificationList.add(new Notification(event.getEventId(),days,event.getStartTime(), notify));
